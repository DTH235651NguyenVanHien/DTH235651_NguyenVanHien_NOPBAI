...
worksheet.write("B1", "Ma san pham", bold)
worksheet.write("C1", "Ten san pham", bold)
worksheet.write("D1", "So luong", bold)
worksheet.write("E1", "Don gia", bold)
...
worksheet.insert_image("B5", "chuong_7/cau_7.png")
